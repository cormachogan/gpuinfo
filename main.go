...
func main() {
	...
	mgr, err := ctrl.NewManager(ctrl.GetConfigOrDie(), ctrl.Options{
		...
		LeaderElectionID:   "ce376515.corinternal.com",
	})
	if err != nil {
...
func vlogin(ctx context.Context, vc, user, pwd string) (*vim25.Client, *govmomi.Client, error) {
	...
	if err != nil {
		setupLog.Error(err, "GPUInfo: vim25 login not successful", "controller", "VMInfo")
		os.Exit(1)
	}
	...
	if err != nil {
		setupLog.Error(err, "GPUInfo: gomvomi login not successful", "controller", "VMInfo")
		os.Exit(1)
	}
